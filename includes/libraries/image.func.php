 ...
 * ============================================================================
 * $Id: image.func.php 8347 2015-09-11 00:32:28Z shaozz $
 */
...
function make_thumb2($src, $dst, $thumb_height, $thumb_width2 = 0, $quality = 85)
{
    if (function_exists('imagejpeg'))
    {
    	//var_dump(function_exists);
        ...
        $src_height = $data[1];
            ...
            $thumb_width2 = $src_width * $thumb_height / $src_height;
            $dst_x = 0;
            $dst_y = 0;
            $dst_w = $thumb_width2;
            $dst_h = $thumb_height;
        ...
        $ni = $func_imagecreate($thumb_width2, $thumb_height);
        if ($func_imagecreate == 'imagecreatetruecolor')
        {
            imagefill($ni, 0, 0, imagecolorallocate($ni, 255, 255, 255));
 ...
 * @return void
 */
function water_mark($src, $mark_img, $position = 'rb', $quality = 95, $pct = 80) {
