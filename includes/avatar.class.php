...
//头像 配置 add by Xiao5
// define('DATADIR', 'D:/wamp/www/alicaifeng/upload');
// define('DATAURL', 'http://local.cf.com/upload');
/*if ($_SERVER['HTTP_HOST'] == 'local.caifeng.com' && PHP_OS == 'Darwin')
{//as 小5
    define('DATADIR', '/private/var/www/local.caifeng.com/upload');
    define('DATAURL', 'http://local.caifeng.com/upload');

}elseif ($_SERVER['HTTP_HOST'] == 'www.kuteid.com'){
    define('DATADIR', '/home/www/alicaifeng/upload');
    define('DATAURL', 'http://www.kuteid.com/upload');    
}
elseif ($_SERVER['HTTP_HOST'] == 'api.alicaifeng.com'){
    define('DATADIR', '/home/www/alicaifeng/upload');
    define('DATAURL', 'http://www.kuteid.com/upload');    
}
elseif ($_SERVER['HTTP_HOST'] == 'local.cf.com'){ //as 宁帅
	define('DATADIR', 'D:/wamp/www/alicaifeng/upload');
	define('DATAURL', 'http://local.cf.com/upload');
	
}elseif ($_SERVER['HTTP_HOST'] == 'new.api.dev.mfd.cn'){ 
	define('DATADIR', '/home/www/mfddiy/mfd/upload');
	define('DATAURL', 'http://new.www.dev.mfd.cn/upload');
}
elseif ($_SERVER['HTTP_HOST'] == 'new.www.dev.mfd.cn'){
    define('DATADIR', '/home/www/mfddiy/mfd/upload');
    define('DATAURL', 'http://new.www.dev.mfd.cn/upload');
}
elseif ($_SERVER['HTTP_HOST'] == 'www.mfd.cn'){
    define('DATADIR', ROOT_PATH.'/upload');
    define('DATAURL', 'http://www.mfd.cn/upload');
}
elseif ($_SERVER['HTTP_HOST'] == 'api.mfd.com'){
    define('DATADIR', ROOT_PATH.'/upload');
    define('DATAURL', 'http://api.mfd.com/upload');
}
elseif ($_SERVER['HTTP_HOST'] == 'local.mfd.com'){
    define('DATADIR', 'D:/www/mfddiy/trunk/mfd/upload');
    define('DATAURL', 'http://api.mfd.com/upload');
}

elseif ($_SERVER['HTTP_HOST'] == 'api.cy.mfd.cn'){
    define('DATADIR', ROOT_PATH.'/upload');
    define('DATAURL', 'http://local.mfddiy.com/upload');
}
...
}elseif ($_SERVER['HTTP_HOST'] == 'api.dev.mfd.cn:8080'){
    define('DATADIR', '/data/www/mfddiy/mfd/upload');
    define('DATAURL', 'http://www.dev.mfd.cn:8080/upload');
}
      */

 define('DATADIR', ROOT_PATH.'/upload');
 define('DATAURL', SITE_URL.'/upload');
...
//        imagecopy($dst_img,$src_img,0,0,$src_x,$src_y,$ww,$hh);
        ...
        imagedestroy($dst_img);
        //返回路径
        $avatarfile = SITE_URL.'/upload/avatar/'.$this->avatar_file($uid, $size);
        return $avatarfile;
    }
