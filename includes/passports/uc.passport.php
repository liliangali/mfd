...
class UcPassportUser extends BasePassportUser
{
    ...
    function get($flag, $is_name = false)
    {
        ...
        list($user_id, $user_name, $email,$password,$salt) = $user_info;
    ...
    function auth($user_name, $password)
    {
        ...
        //$isuid 根据邮箱=2 用户名默认0 add by 小五 at 2016.05.09
        $isuid = 0;
        $result = outer_call('uc_user_login', array($user_name, $password,$isuid));
