<?php
/* 面料数据模型 */
class WorkCustomModel extends BaseModel{
    var $table  = 'work_custom';
    var $prikey = 'id';
    var $alias  = 'c';
    var $_name  = 'workCustom';
    var $_prefix = "diy_";

    var $_obj_search='name|基本款名称';
    var $_obj_fields='id|ID,name|名称,price|价格,source_img|大图';//,small_img|小图
    var $_obj_images = 'source_img'; //small_img,
    var $_order  = 'last_time desc';
    var $temp; // 临时变量
    var $_relation = array(
