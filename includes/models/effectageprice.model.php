...
/* 功效犬期价格表 effect_age_price */
class EffectAgePriceModel extends BaseModel
{
    var $table  = 'effect_age_price';
    var $prikey = 'ea_id';
    var $alias='eap';
    var $_name  = 'effectageprice';
    var $_relation = array(
    );
...
/*         if($acategory['code'] == ACC_SYSTEM || $acategory['code'] == ACC_NOTICE || $acategory['code'] == ACC_HELP)
        {
            return false;
        }
        else
