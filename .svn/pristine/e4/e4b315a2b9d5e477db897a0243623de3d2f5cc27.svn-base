...
class SwfuploadApp extends BackendApp
{
    ...
    function SwfuploadApp()
    {
        ...
        if (isset($_POST["MFD_ID"]) && isset($_POST['HTTP_USER_AGENT']))
        {
            $_COOKIE['MFD_ID'] = $_POST["MFD_ID"];
        ...
        /* switch ($this->belong){
            case BELONG_ARTICLE :   $this->save_path = UPLOAD_ARTICLE;
            break;
            case BELONG_B2C     :   $this->save_path = UPLOAD_B2C;
            break;
            case BELONG_C2M     :   $this->save_path = UPLOAD_C2M;
            break;
            case BELONG_MEMBER  :   $this->save_path = UPLOAD_MEMBER;
            break;
            default:
               $this->save_path = UPLOAD_ARTICLE;
            break;
        } */
        $this->mod_uploadedfile = &m('uploadedfile');
    }
