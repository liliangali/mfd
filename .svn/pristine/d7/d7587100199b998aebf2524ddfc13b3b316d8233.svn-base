 ...
 *    @author liang.li
 */
class TestSiteApp extends BackendApp
{
    var $_city_mod;
    var $siteType;
    var	$type;
    ...
    function CityApp()
    {
		...
		$this->type = array(0=>"综合",1=>"男装",2=>'女装',3=>'童装');
        $this->_city_mod = & m('testsite');
    }
    ...
    function add()
    {
    	if (!IS_POST)
    	{
    		...
    		//=====基本信息=====
    		$city = array('is_open'=>1,'sort_order'=>255,'city_name'=>'北京市');
...
//     	dump($data);
    		...
    		$this->show_message('添加成功',
                'back_list', 'index.php?app=testsite');
    	}
    }
