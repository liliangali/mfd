 ...
 *    @usage    none
 */
class Zhek_promotionApp extends BackendApp
{
    ...
    function index()
    {
        ...
        $this->display('zk/goods_promotion.index.html');
    }
     /**
     *    新增促销规则
     *
    ...
    function add()
    {
        if (!IS_POST)
        {
            ...
            $this->display('zk/goods_promotion.form.html');
        ...
        { 
            ...
            if($id){
             ...
             if($id){
                $this->show_message('添加成功','back_list', 'index.php?app=zhek_promotion&act=index&amp;cate_id=0');
            }else{
                $this->show_message('添加失败','<<返回', 'index.php?app=zhek_promotion&act=add&amp;cate_id=0');
            }  
    ...
    function edit(){
        ...
        if(!IS_POST){
           ...
           // $site_name = implode(",", $site_name);
            ...
            if($r){
                $this->show_message('修改成功','back_list', 'index.php?app=zhek_promotion&act=index');
            }else{
                $this->show_message('修改失败','<<返回', 'index.php?app=zhek_promotion&act=edit');
            }  
    ...
    function loadgoods(){
      ...
      function drop(){
        ...
        $this->show_message('促销规则删除成功','<<返回','index.php?app=zhek_promotion&act=index&amp;cate_id=0');
    }
