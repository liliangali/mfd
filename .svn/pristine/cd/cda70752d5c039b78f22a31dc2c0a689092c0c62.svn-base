        ...
        return t = function() {
            function t(t) {
                ...
                this.input = t,
                    ...
                    this.slider = $("<div>").addClass("srs-slider").insertAfter(this.input),
                    this.minus = $("<div><span>-</span></div>").addClass("srs-minus").appendTo(this.slider),
                    this.plus = $("<div><span>+</span></div>").addClass("srs-plus").appendTo(this.slider),
                    this.track = $("<div>").addClass("srs-track").appendTo(this.slider),
                    this.thumb = $("<div ontouchend='shuliang()'><span>").addClass("srs-thumb").appendTo(this.track),
                    this.bubble = $("<div><span class='slider-status'>").addClass("srs-bubble").appendTo(this.thumb).hide(),
                ...
                (this.value >= this.limit || this.decimals > 0) && this.toggleBubble(!0),
                        ...
                        function(t) {
                            return function(i) {
                                ...
                                return i.preventDefault(),
                                    ...
                                    t.setValue(s),
                                    t.positionThumb(s),
                                    t.value >= t.limit || t.decimals > 0 ? t.toggleBubble(!0) : t.toggleBubble(!1)
                            }
                        } (this)),
                    this.plus.on("click",
                        function(t) {
            ...
            return t.prototype.toggleBubble = function(t) {
                ...
                t.prototype.setValue = function(t) {
                    ...
                    return this.value = Math.round((t - this.min) / this.step) * this.step + this.min,
                        ...
                        this.bubbleNumber.text(i),
                        this.value >= this.limit || this.decimals > 0 ? this.thumbNumber.text("") : this.thumbNumber.text(i)
                },
