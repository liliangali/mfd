 ...
 * ============================================================================
 * $Id: session.lib.php 8228 2015-09-08 03:08:32Z zhaoxr $
 */
...
class SessionProcessor
{
    ...
    function _sess_write($sesskey, $sessvalue)
    {
        ...
        {
            $this->db->query("REPLACE INTO `cf_sessions_data` SET sesskey = '{$this->session_id}', expiry={$expiry}, data='{$sessvalue}'");
            $is_overflow = 1;
            $sessvalue = '';
        }
    ...
    function insert_session()
    {
        ...
        $userid  = !empty($_SESSION['user_id'])  ? intval($_SESSION['user_id'])  : 0;
        $expiry  = $this->get_expiry();
        return $this->db->query('REPLACE INTO ' . $this->session_table . " SET sesskey = '" . $this->session_id . "', expiry = '" . $expiry . "', ip = '" . $this->_ip . "', userid = '" . $userid . "', adminid = '" . $adminid . "', data = ''");
    }
