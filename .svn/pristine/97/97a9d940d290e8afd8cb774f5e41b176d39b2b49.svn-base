...
//         	),
            ...
            'giveaway' => array(
                'text'  => "赠品列表",
                'url'   => 'index.php?app=giveaway',
            ),
            'package' => array(
                'text'  => "赠品礼包列表",
                'url'   => 'index.php?app=package',
            ),
...
//            ),
          /*  'goods_promotion' => array(
			...
			'manjian_promotion' => array(
                'text'  => '满减优惠活动',
                'url'   => 'index.php?app=manjian_promotion',
            ),
			'zhek_promotion' => array(
                'text'  => '折扣优惠活动',
                'url'   => 'index.php?app=zhek_promotion',
            ),
            'first_order' => array(
                'text'  => '注册送券',
                'url'   => 'index.php?app=setting&act=forder',
            ),
