...
class BasePayment extends Object
{
    ...
    {
    	if($type == "order"){
        	//return SITE_URL . "/index.php/paynotify-notify-{$order_id}.html";
			return "http://m.kuteid.com/index.php/paynotify-notify-{$order_id}.html";
    	}else{
    		//return SITE_URL . "/index.php/paynotify-accountnotify-{$order_id}.html";
			return "http://m.kuteid.com/index.php/paynotify-accountnotify-{$order_id}.html";
    	}
    }
  
    function _create_m_notify_url($order_id,$type=""){
        $port = isset($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT'] != '80' ? ':'.$_SERVER['SERVER_PORT'] : '';
        
        if($type =='news' || $type=="fabricbook" || $type == "coin"){
            return 'http://'.$_SERVER['SERVER_NAME'].$port."/paynotifys-notify-{$order_id}.html";
        } elseif($type =='account') {
			return 'http://'.$_SERVER['SERVER_NAME'].$port."/paynotify-accountnotify-{$order_id}.html";
		} elseif($type=="kuka" || $type=="kubi") {
			return 'http://'.$_SERVER['SERVER_NAME'].$port."/paynotify-kukanotify-{$order_id}.html";
		} elseif($type=="fx"){
		    return 'http://'.$_SERVER['SERVER_NAME'].$port."/paynotify-fxanotify-{$order_id}.html";
		}
		return false;
    	return "http://m.kuteid.com/index.php/paynotify-notify-{$order_id}.html";
    }
     
    function _create_m_return_url($order_id,$type=""){
        $port = isset($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT'] != '80' ? ':'.$_SERVER['SERVER_PORT'] : '';
        
        if($type =='news' || $type=="fabricbook" || $type == "coin"){
            return 'http://'.$_SERVER['SERVER_NAME'].$port."/paynotifys-index-{$order_id}.html";
        } elseif($type =='account') {
			return 'http://'.$_SERVER['SERVER_NAME'].$port."/paynotify-account-{$order_id}.html";
		} elseif($type=="kuka" || $type=="kubi") {
			return 'http://'.$_SERVER['SERVER_NAME'].$port."/paynotify-kuka-{$order_id}.html";
		}elseif($type =='fx'){
		    return 'http://'.$_SERVER['SERVER_NAME'].$port."/paynotify-fx-{$order_id}.html";
		}
    	return "http://m.kuteid.com/index.php/paynotify-{$order_id}.html";
    }
    /**
     *    获取返回地址
     *
    ...
    {
    	if($type == "order"){
    		//return SITE_URL . "/index.php/paynotify-{$order_id}.html";
			return "http://m.kuteid.com/index.php/paynotify-{$order_id}.html";
    	}else{
    		//return SITE_URL . "/index.php/paynotify-account-{$order_id}.html";
			return "http://m.kuteid.com/index.php/paynotify-account-{$order_id}.html";
    	}
