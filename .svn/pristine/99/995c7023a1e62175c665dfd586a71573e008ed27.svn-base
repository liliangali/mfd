...
class My_categoryApp extends StoreadminbaseApp
{
    ...
    function index()
    {
        $this->assign('title','RCTAILOR-酷客中心-分类管理');
        $this->assign('title_info','分类管理');
        /* 取得商品分类 */
        ...
        $this->_curlocal(LANG::get('member_center'), '/index.php/member.html',
                         LANG::get('my_category'), '/index.php/my_category.html',
...
//        );
    ...
    function add()
    {
        $this->assign('title','RCTAILOR-酷客中心-添加分类');
        $this->assign('title_info','添加分类');
        if (!IS_POST)
        {
            /* 当前页面信息 */
            $this->_curlocal(LANG::get('member_center'), '/index.php/member.html',
    ...
    function edit()
    {
        $this->assign('title','RCTAILOR-酷客中心-编辑分类');
        $this->assign('title_info','编辑分类');
    ...
    function drop()
    {
        ...
        $this->show_message('drop_ok');exit;
    }
    ...
    function _get_member_submenu()
    {
        $menus = array(
            array(
                ...
                'url'  => '/index.php/my_category.html',
            ),
            );
        return $menus;
    }
