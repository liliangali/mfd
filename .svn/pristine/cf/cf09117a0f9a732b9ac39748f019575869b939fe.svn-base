...
//		echo '<pre>';print_r($map);exit;
	...
	function ajax_col()
	{
		...
		$data   = array();
		if (in_array($column ,array('cate_name','is_def', 'if_show', 'sort_order','is_alone','is_try')))
		{
			$data[$column] = $value;
			if($column == 'cate_name')
			{
	...
	function add()
	{
		...
		else
		{
				...
				$data = array(
                        ...
                        'is_try'    => isset($_POST['is_try'])?$_POST['is_try']:'0',
	...
	function edit()
	{
		...
		else
		{
		    ...
		    $data = array(
		        ...
		        'is_box'    => isset($_POST['is_box'])?$_POST['is_box']:'1',
		        'is_alone'    => isset($_POST['is_alone'])?$_POST['is_alone']:'0',
                'is_try'    => isset($_POST['is_alone'])?$_POST['is_try']:'0',
		        'if_common'    => isset($_POST['if_common'])?$_POST['if_common']:'1',
		        'uprice'    => $_POST['uprice'],
		        'fprice'    => $_POST['fprice'],
		        'small_img'     => isset($_POST['small_img'])?addslashes($_POST['small_img']):'',
