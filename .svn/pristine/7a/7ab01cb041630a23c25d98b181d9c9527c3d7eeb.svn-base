...
class BaseVisitor extends Object
{
    ...
    function _get_detail()
    {
        ...
        $member_info = $model_member->findAll(array(
            ...
            'fields'        => 'member.email, point, user_token, coin, money, member.serve_type mserve_type, frozen, password, member.real_name, logins, portrait, store_id, store.state, sgrade , idserve,serve.state servestate,serve.serve_type,serve.idserve,member.member_lv_id',
