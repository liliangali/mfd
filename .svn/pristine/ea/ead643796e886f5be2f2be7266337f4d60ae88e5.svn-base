...
/* 申请品牌商111 */
class MesApp extends MallbaseApp
{
...
//    }
    ...
    function index()
    {
        ...
        $orderLib = new Orders();
        $res = $orderLib->mefbn($order_id,$bn,$bcode);
    ...
    function sta()
    {
        ...
        $goods = Types::createObj("fdiy");
        #TODO mes接口修改标签图
//        $mesref = $goods->mesimg(9685,"http://www.myfoodiepet.com/upload/images/diy/deca4d37bc55bdcff02f9b241e5e7649.jpg");
        $price_arr = $goods->sta(5933);
