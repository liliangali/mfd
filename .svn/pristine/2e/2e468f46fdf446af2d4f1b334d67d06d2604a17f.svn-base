 ...
 * ============================================================================
 * $Id: session.lib.php 7609 2015-08-20 08:02:22Z liugx $
 */
...
class SessionProcessor
{
    ...
    var $max_life_time  = 8888; // SESSION 过期时间
     ...
     * @return void
     */
    function __construct(&$db, $session_table, $session_data_table, $session_name = 'mfd_ID', $session_id = '')
    {
     ...
     * @return void
     */
    function SessionProcessor(&$db, $session_table, $session_data_table, $session_name = 'mfd_ID', $session_id = '')
    {
    ...
    function _sess_write($sesskey, $sessvalue)
    {
        ...
        {
            $this->db->query("REPLACE INTO  $this->session_data_table  SET sesskey = '{$this->session_id}', expiry={$expiry}, data='{$sessvalue}'");
            $is_overflow = 1;
            $sessvalue = '';
        }
    ...
    function my_session_start()
    {
            ...
            //session_set_cookie_params(0, $this->session_cookie_path, null, $this->session_cookie_secure);
            //session_cache_expire(1);
            
            //session_set_cookie_params( 12*60*60);//设置cookie的有效期
            //session_cache_expire(1);//设置session的有效期
            session_set_cookie_params(365*24*60*60, $this->session_cookie_path, null, $this->session_cookie_secure);
...
class MemcacheSession
{
    ...
    function __construct($memcache_servers, $session_name = 'mfd_ID')
    {
        $this->MemcacheSession($memcache_servers, $session_name);
    }
    
    function MemcacheSession($memcache_server, $session_name = 'mfd_ID')
    {
