...
class TemplateApp extends BackendApp
{
    ...
    {
        return array(
            'index' => SITE_URL . '/default-index.html',
        	//'dissertation' => SITE_URL . '/index.php/dissertation.html',
        );
    }
}
