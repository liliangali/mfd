...
return array(
	...
	'toseller_serve_2_refused_notify'=> '抱歉，您的服务点申请已被拒绝，原因如下： {$reason}',
	'toseller_serve_3_refused_notify'=> '抱歉，您的加盟商申请已被拒绝，原因如下： {$reason}',
	'toseller_serve_4_refused_notify'=> '抱歉，您的设计师申请已被拒绝，原因如下： {$reason}',

	'toseller_serve_4_passed_notify' => '恭喜，您的设计师申请已开通，请重新 [url={$site_url}/index.php/member-logout.html]登录[/url] 页面，进行作品的上传。',
