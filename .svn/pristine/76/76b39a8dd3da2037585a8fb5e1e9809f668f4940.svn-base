...
class XingeMeg
{
	...
	//==================mfd项目=====================
	//安卓应用信息-mfd
	const ANDROID_mfd_ACCESS_ID  = '2100119953';  
    const ANDROID_mfd_SECRET_KEY = 'b27f6fb53e4f344ea3abb8572e88d5db';	
	
	//ios应用信息--mfd--麦富迪企业证书发布
	const IOS_mfd_ACCESS_ID  = '2200122410';  
    const IOS_mfd_SECRET_KEY = '2625b5ca763d022ad4ed1b4888468190';
	
	//ios应用信息--mfd--appstore
	const IOS_mfd_ACCESS_ID_STORE  = '2200119954';  
    const IOS_mfd_SECRET_KEY_STORE = 'cba1c3b73819c10bedc430260c586690';
