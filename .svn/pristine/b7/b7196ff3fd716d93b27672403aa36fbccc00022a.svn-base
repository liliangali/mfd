    ...
    function edit()
    {
        ...
        else
        {
            ...
            if ($old_data['parent_id'] != $data['parent_id'])
            {
                ...
                $sql = "SELECT DISTINCT cat_id FROM {$mod_goods->table} WHERE cat_id " . db_create_in($cids);
              ...
              /*   foreach ($cate_ids as $cate_id)
                {
                    ...
                    $sql = "UPDATE {$mod_goods->table} " .
                            "SET cat_id_1 = '{$cate_id_n[0]}', cat_id_2 = '{$cate_id_n[1]}', cat_id_3 = '{$cate_id_n[2]}', cat_id_4 = '{$cate_id_n[3]}' " .
