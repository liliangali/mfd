...
;!function(a){
	...
	Class.pt.offset=function(n){
		...
		obj.style.top=(h1/2-h2/2>0?h1/2-h2/2:0)+'px';
		$(obj).addClass('show');
	}
	//拖拽层
    ...
    a.luck = {
		...
		alert:function(tit,con,ico,w,fn){
			a.luck.open({
				width:w?w:'255px',
				content:'<div class="luck-move luck-dialog luck-ico-'+(ico?ico:0)+'"><i class="luck-ico"></i>'+con+'</div>',
				cloBtn:false,
				yes:function(obj){
		...
		poptip:function(opt) {//逐渐废弃luck.alert方法
			a.luck.open({
		...
		confirm:function(tit,con,calback,btnTxt){
			a.luck.open({
				title:tit,
				width:"255px",
				content:'<span class="luck-move luck-dialog luck-ico-3"><i class="luck-ico"></i>'+con+'</span>',
				cloBtn:false,
				btn:btnTxt,
				yes:function(obj){
