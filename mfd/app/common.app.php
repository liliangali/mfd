...
//         }
        ...
        $ajaxpage=new minupage(array('total'=>$this->_customs_mod->getCount(),'perpage'=>10,'ajax'=>'ajax_page','page_name'=>'page','nowindex'=>empty($_REQUEST['page']) ? 1 : $_REQUEST['page'],'url'=>'/mfd/index.php?app=common&act=ajax_get'));
