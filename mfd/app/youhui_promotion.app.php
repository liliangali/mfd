 ...
 *    @usage    none
 */
class Youhui_promotionApp extends BackendApp
{
    ...
    function index()
    {
        ...
        $this->display('yh/goods_promotion.index.html');
    }
     /**
     *    新增促销规则
     *
    ...
    function add()
    {
        if (!IS_POST)
        {
            ...
            $this->display('yh/goods_promotion.form.html');
        ...
        { 
          ...
          /*  if(!in_array($favorable, array(1,2,3,4))){
            ...
            if($id){
             ...
             if($id){
                $this->show_message('添加成功','back_list', 'index.php?app=youhui_promotion&act=index&amp;cate_id=0');
            }else{
                $this->show_message('添加失败','<<返回', 'index.php?app=youhui_promotion&act=add&amp;cate_id=0');
            }  
    ...
    function edit(){
        ...
        if(!IS_POST){
          ...
          /*  if(!in_array($favorable, array(1,2,3,4))){
            ...
            if($r){
                $this->show_message('修改成功','back_list', 'index.php?app=youhui_promotion&act=index');
            }else{
                $this->show_message('修改失败','<<返回', 'index.php?app=youhui_promotion&act=edit');
            }  
    ...
    function loadgoods(){
      ...
      function drop(){
        ...
        $this->show_message('促销规则删除成功','<<返回','index.php?app=youhui_promotion&act=index&amp;cate_id=0');
    }
