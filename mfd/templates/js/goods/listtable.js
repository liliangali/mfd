/* $Id: listtable.js 318 2015-04-27 00:21:26Z xiao5 $ */
 ...
 * 创建一个可编辑区
 */
listTable.edit = function(obj,app,act, id)
{
  ...
  txt.onblur = function(e)
  {
    ...
    {
      res = Ajax.call(listTable.url, "app="+app+"&act="+act+"&val=" + encodeURIComponent(Utils.trim(txt.value)) + "&id=" +id, null, "POST", "JSON", false);
 ...
 * 删除列表中的一个记录
 */
listTable.remove = function(btn,id, cfm,app,opt)
{
  if (opt == null)
  {
    opt = "remove";
  ...
  if (confirm(cfm))
  {
    var args = "app="+app+"&act=" + opt + "&id=" + id + this.compileFilter();

    Ajax.call(this.url, args, null, "GET", "JSON");
    var objTR =btn.parentNode.parentNode;
