...
<div id="rightTop">
    ...
    <ul class="subnav">
        <li><span>管理</span></li>
        <li><a class="btn1" href="index.php?app=gcategory&amp;act=add">添加</a></li>
    </ul>
</div>
...
<div class="info2">
    <table  class="distinction">
        ...
        <tr class="tatr1">
            ...
            <td width="50%"><span class="all_checkbox"><label for="checkall_1">全选</label></span>
            分类名称
            </td>
            <td>排序</td>
            <td>显示</td>
...
?>
        <tr>
            ...
            <td class="handler"><span><a href="index.php?app=gcategory&amp;act=edit&amp;id=<?php echo $this->_var['gcategory']['cate_id']; ?>&type_id=<?php echo $this->_var['gcategory']['type_id']; ?>">编辑</a>
                |
                <a href="javascript:if(confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗'))window.location = 'index.php?app=gcategory&amp;act=drop&amp;id=<?php echo $this->_var['gcategory']['cate_id']; ?>&type_id=<?php echo $this->_var['gcategory']['type_id']; ?>';">删除</a><?php if ($this->_var['region']['layer'] < $this->_var['max_layer']): ?> | <a href="index.php?app=gcategory&amp;act=add&amp;pid=<?php echo $this->_var['gcategory']['cate_id']; ?>&type_id=<?php echo $this->_var['gcategory']['type_id']; ?>">新增下级</a><?php endif; ?>
                </span>
            </td>
        </tr>
        <?php endforeach; else: ?>
