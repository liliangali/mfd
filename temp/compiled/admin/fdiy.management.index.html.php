...
<div id="rightTop">
    <ul class="subnav">
        <li><span>管理</span></li>
        <li><a class="btn1" href="index.php?app=diyM&amp;act=add">新增</a></li>
    </ul>
</div>
<div class="info2">
...
?>
            <tr>
                ...
                <td class="node" width="50%"><?php echo htmlspecialchars($this->_var['acategory']['cname']); ?></td>
                ...
                <td class="handler"><span>
                    ...
                    <a href="index.php?app=diyM&amp;act=edit&amp;id=<?php echo $this->_var['acategory']['cate_id']; ?>">编辑</a> | <a href="javascript:if(confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗'))window.location = 'index.php?app=diyM&amp;act=drop&amp;id=<?php echo $this->_var['acategory']['cate_id']; ?>';">删除</a>
                    <?php endif; ?>
                    <?php if ($this->_var['acategory']['layer'] < $this->_var['max_layer'] && $this->_var['acategory']['parent_children_valid']): ?>
                    <?php if (! $this->_var['acategory']['code']): ?>
                    |
                    <?php endif; ?>
                    <a href="index.php?app=diyM&amp;act=add&amp;pid=<?php echo $this->_var['acategory']['cate_id']; ?>">新增下级</a>
                    <?php endif; ?>
                    </span> </td>
            </tr>
            <?php endforeach; else: ?>
            <tr class="no_data">
                <td colspan="5">暂无工艺分类</td>
            </tr>
        ...
        <tfoot>
            <tr class="tr_pt10">
                ...
                <td colspan="4" id="batchAction"><span class="all_checkbox">
                    <label for="checkall_2">全选</label>
                    </span>&nbsp;&nbsp;
                    <input class="formbtn batchButton" type="button" value="删除" name="id" uri="index.php?app=diyM&act=drop" presubmit="confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗');" />
