...
<div class="hb_top">
	<div class="hb_top_1">
		...
		<p><?php echo $this->_var['member_info']['nickname']; ?></p>
	</div>
...
<div class="hb_xx">
	<div class="hb_xx_left">
		<p>狗狗：<span><?php echo $this->_var['goods_item']['dog_name']; ?></span></p>
		<p>犬期：<span><?php echo $this->_var['goods_item']['quanqi']; ?></span></p>
		<p>生日：<span><?php echo $this->_var['goods_item']['dog_date']; ?></span></p>
		<p>功效：<span><?php echo $this->_var['goods_item']['gongxiao_str']; ?></span></p>
	</div>

	<div class="hb_xx_right">
		<p>主人寄语</p>
		<p><?php echo $this->_var['goods_item']['dog_desc']; ?></p>
	</div>
</div>
<div class="hb_bottom">
	...
	var ua1 = navigator.userAgent.toLowerCase();
		...
		wx.ready(function () {
			...
			wx.onMenuShareTimeline({
				title: '<?php echo $this->_var['goods_item']['goods_name']; ?>', // 分享标题
				link: '<?php echo $this->_var['goods_item']['url']; ?>', // 分享链接
				imgUrl: '<?php echo $this->_var['goods_item']['style']; ?>', // 分享图标
				success: function () {
				},
				cancel: function () {
				}
			...
			wx.onMenuShareAppMessage({
				...
				link: '<?php echo $this->_var['goods_item']['url']; ?>', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
				imgUrl: '<?php echo $this->_var['goods_item']['style']; ?>', // 分享图标
