...
<script type="text/javascript" src="public/static/expand/jquery.js"></script>
<style>
@charset "utf-8";
/*--全局/S--*/
...
/*--当前步骤/S--*/
.pwd-step {width: 660px; height: 20px; margin: 50px auto; background: #eee; border-radius: 15px; text-align: center; font-size: 12px; color: #333;}
.pwd-step p {float: left; width: 220px;}
.pwd-step .on {color: #fff; background: #e66800; border-radius: 15px;}
/*--当前步骤/E--*/
...
.myForm .p {overflow: hidden; padding-bottom: 20px; font-size: 14px;}
.AreaL .myForm {padding: 40px 0 0 100px;}
...
.AreaR .RegR .btn {display: block; width: 223px; height: 52px; line-height: 50px; text-align: center; line-height: 50px; background-color: #ededed; background: url(static/img/btn2.png) no-repeat 0 -52px; font-size: 14px; margin: 50px auto;}
.AreaR .RegR .btn:hover {background-position: 0 0;}
.AreaR .RegR .btn:active {opacity: 0.8;}
/*--基本表单/E--*/

/*--错误信息/S--*/
#error {height: 60px; line-height: 60px; color: #e66800; font-size: 14px;}
#error .ico {float: left; width: 24px; height: 24px; background: url(static/img/bg2.png) no-repeat -79px -54px; margin: 18px 5px 0 0;}
...
.verifyOk .txt {padding-left: 240px; font-size: 24px; line-height: 24px; margin-bottom: 20px; color: #000; overflow: hidden;}
...
.verifyOk .txt p {clear: both; padding: 15px 0 0 62px; font-size: 14px; color: #666;}
...
.verifyOk .btn-red span {display: block; height: 40px; background:#e66800}
...
.verifyOk .btn-grey:hover span {background:#ce5e02;}
...
<div class="main w">
  <div class="pwd-step pwd-1"><p class="on">1、验证身份</p><p>2、重置登录密码</p><p>3、完成</p></div>
  <div class="myForm">
    <div id="error"></div>
    <div class="phoneBox">
...
/* var url = "<?php echo $this->build_url(array('app'=>'cart','act'=>'add')); ?>";  */
