            ...
            <div class="grzlqh">
                ...
                <form method="post" >
                    <table width="100%" border="0" class="grtab">
                        <tr>
                            <td>昵称：<input name="nickname" type="text" class="grzlinp" validate="required" tip="昵称" value="<?php echo $this->_var['user']['nickname']; ?>"></td>
                        </tr>
                        <tr>
                            <td>姓名：<input name="real_name" type="text" class="grzlinp" validate="required" tip="名称" value="<?php echo $this->_var['user']['real_name']; ?>"></td>
                        </tr>
                        <tr>
                            <td>手机：<input name="phone_mob" type="text" class="grzlinp" validate="required|phone" tip="手机" value="<?php echo $this->_var['user']['user_name']; ?>"></td>
                        </tr>
                        <tr>
                            <td>邮箱：<input name="email" type="text" class="grzlinp" validate="required|email" tip="邮箱" value="<?php echo $this->_var['user']['email']; ?>"></td>
                        </tr>
                        <tr>
                            <td>性别：<input name="sex" type="radio" class="grxz" value="1"  <?php if ($this->_var['profile']['gender'] == 1): ?>checked<?php endif; ?>>&nbsp;&nbsp;男<input name="sex" type="radio" class="grxz" value="2"  <?php if ($this->_var['profile']['gender'] == 2): ?>checked<?php endif; ?>> &nbsp;&nbsp;女</td>
                        </tr>
                        <tr>
