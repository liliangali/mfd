...
class MessageApp extends MemberbaseApp
{
    ...
    function newpm()
    {
        $this->assign('title','RCTAILOR-酷客中心-站内消息');
        $this->assign('title_info','站内消息');
        $this->_clear_newpm_cache();

        /* 当前位置 */
        $this->_curlocal(LANG::get('member_center'),   '/index.php/member.html',
                         LANG::get('message'),         '/index.php/message-newpm.html',
                         LANG::get('newpm')
                         );
    ...
    function drop()
    {
        ...
        if (in_array($_GET['back'],array('newpm', 'privatepm')))
        {
            $this->show_message('drop_message_successed',
                'back_' . $_GET['back'] ,'/index.php/message-' . $_GET['back'] . '.html');
        }
        else
        {
            $this->show_message('drop_message_successed');
    ...
    function drop_relate()
    {
        ...
        {
            //修改BUG
            header("Location:/index.php/message-newpm.html");
            return;
        }
    }
    ...
    function _get_member_submenu()
    {
        ...
        $menus = array(
                array(
                    'name'  => 'newpm',
                    'url'   => '/index.php/message-newpm.html',
                    'text'  => Lang::get('newpm') . $newpm,
                ),
                // array(
                //     'name'  => 'privatepm',
                //     'url'   => '/index.php/message-privatepm.html',
                //     'text'  => Lang::get('privatepm'),
                // ),
                array(
                    'name'  => 'systempm',
                    'url'   => '/index.php/message-systempm.html',
        ...
        if ($ms->pm->show_announce)
        {
            $menus[] = array(
                    'name'  => 'announcepm',
                    'url'   => '/index.php/message-announcepm.html',
