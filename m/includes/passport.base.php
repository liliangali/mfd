...
class BasePassport extends Object
{
    ...
    function BasePassport()
    {
        ...
        $order_class_name = ucfirst($this->_name) . 'PassportOrder';
...
class BasePassportPM extends Object
{
     ...
     *    @return    array:消息列表
     */
    function get_list($user_id, $limit, $folder = 'privatepm')
    {
        #TODO
    }
...
/**
 * 订单接口基础类
 * @see BasePassportOrder
 * @version 1.0.0 (2014-12-1)
 * @author Ruesin <ruesin@163.com>
 */
class BasePassportOrder extends Object
{
    //创建订单
