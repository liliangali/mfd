...
$('span[ectype="inline_edit"]').click(function(){
    ...
    $('<input type="text">').css({border:'1px solid #ccc',width:'80%',height:'20px'})
                        ...
                        if(event.keyCode == 13)
                        {
                            ...
                            $.get('index.php/'+app+'-ajax_col.html?ajax=1',{id:s_id,column:s_name,value:$(this).attr('value')},function(data){
                                if(data === 'false')
                                {
...
$('img[ectype="inline_edit"]').click(function(){
                ...
                $.get('index.php/'+app+'-ajax_col.html?ajax=1',{id:i_id,column:i_name,value:i_val},function(data){
                if(data === 'true')
                    {
