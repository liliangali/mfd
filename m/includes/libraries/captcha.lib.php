 ...
 * ============================================================================
 * $Id: captcha.lib.php 4291 2015-05-30 02:41:45Z gaofei $
 */
if (!defined('IN_ECM'))
{
...
class Captcha
{
    ...
    function ttffont()
    {
        ...
        $x = mt_rand($font[0]['angle'] > 0 ? cos(deg2rad(90 - $font[0]['angle'])) * $font[0]['zheight'] : 1, $this->width - $widthtotal > 0 ? $this->width - $widthtotal : 1);
