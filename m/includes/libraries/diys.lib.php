...
//                     }
     ...
     * 当 面料费 ≥ 100元时，面料系数 = 3，工艺：半毛衬
     * 加工费：套装=1180；上衣=780；裤子=400；马甲=250；衬衣=150；大衣=1000
     * 
     * 当面料费 ＜ 100元时，面料系数=1，工艺：粘合衬
     * 加工费：套装=880；上衣=580；裤子=300；马甲=200；衬衣=100；大衣=800
     * 
