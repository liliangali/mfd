...
class Tree extends Object
{
    ...
    function getArrayList($root = 0 , $layer = NULL)
    {
        ...
        foreach ($this->child[$root] as $id)
        {
			...
			{
			    $top_store = $db->getall("select rc_store.store_id,rc_store.store_name from rc_gcategory join rc_category_store on rc_gcategory.cate_id=rc_category_store.cate_id join rc_store on rc_store.store_id=rc_category_store.store_id where rc_gcategory.cate_id = '$id'");
			}
