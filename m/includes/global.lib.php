...
function &gt($type, $params = array())
{
    ...
    {
        /* 加载订单类型基础类 */
        include_once(ROOT_PATH . '/m/includes/goods.base.php');
        include(ROOT_PATH . '/m/includes/goodstypes/' . $type . '.gtype.php');
...
function &ot($type, $params = array())
{
    ...
    {
        /* 加载订单类型基础类 */
        include_once(ROOT_PATH . '/m/includes/order.base.php');
        include(ROOT_PATH . '/m/includes/ordertypes/' . $type . '.otype.php');
...
function &ots($type, $params = array())
{
    ...
    {
        /* 加载订单类型基础类 */
        include_once(ROOT_PATH . '/m/includes/orders.base.php');
        include(ROOT_PATH . '/m/includes/orderstypes/' . $type . '.otype.php');
