...
class ComuploadApp extends BackendApp
{
    ...
    function uploadedfile()
    {
            ...
            if ($files['error'] == UPLOAD_ERR_OK)
            {
                ...
                {
                    $dirname = 'upload/'.$typeDir.'/article/' .date("Ym", time());
                }
                if ($this->belong == BELONG_PROCESS)                {                	$dirname = 'upload/'.$typeDir.'/process/' .date("Ym", time());                }
                if ($this->belong == BELONG_GOODS)
		{
                    $dirname = 'upload/'.$typeDir.'/goods/' .date("Ym", time());
                }
