...
//        $field_serve_type = empty($_GET['serve_type']) ? '' : $_GET['serve_type'];
//
//        if($field_serve_type){
//            $_GET['serve_type'] = $this->_lv_mod->_typeid[$field_serve_type];
//            $conditions .= " and serve_type=".$_GET['serve_type'];
//        }

        $conditions .= " and serve_type=1";
        //ns add 添加等级搜索
        $member_lv = empty($_GET['field_member_lv']) ? '' : $_GET['field_member_lv'];
        if($member_lv){
            $conditions .= " and member_lv_id=".$_GET['field_member_lv'];
        }
