...
<div class="main"> 
	...
	<input name="phome" id="phone" value="" placeholder="请输入您的手机号" class="view" />
...
// 	console.log($('.up p img'));
	...
	$.post('<?php echo $this->build_url(array('app'=>'feedback','act'=>'add')); ?>',{content:content,phone:phone},function(res){
		if(res){
			layer.open({
	    	    content: '提交成功'
	    	    ,skin: 'msg'
