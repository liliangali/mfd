...
<div class="c_db h5_info c_bac bg_white">
   <div class="diy_img"><img src="<?php echo $this->_var['goods_info']['goods_image']; ?>"></div>
   <div class="c_bf1">

      <h1><?php echo $this->_var['goods_info']['goods_name']; ?></h1>

      <span>¥<?php echo $this->_var['goods_info']['price']; ?></span>
   </div>
</div>

<div class="diy_text bg_white">
   <h1>定制信息</h1>
   <p>主人寄语：<?php echo $this->_var['goods_info']['dog_desc']; ?></p>
   <div>
       生长阶段: <?php echo $this->_var['dog']['jieduan']; ?><br>
       功效选择: <?php echo $this->_var['dog']['gongxiao']; ?><br>
       口味选择: <?php echo $this->_var['dog']['kouwei']; ?><br>
       包装: <?php echo $this->_var['dog']['baozhuang']; ?><br>
       规格: <?php echo $this->_var['dog']['kezhong']; ?><br>
       喂食量: <?php echo $this->_var['goods_info']['feed_list']['feed_w']; ?>克/每天<br>
       生日: <?php if ($this->_var['goods_info']['dog_date']): ?><?php echo $this->_var['goods_info']['dog_date']; ?><?php else: ?>未设置<?php endif; ?>
   </div>
</div>
...
<input type="hidden" name="order_goods_id"  value="<?php echo $this->_var['goods_info']['rec_id']; ?>">
