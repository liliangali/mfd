...
<head>
    ...
    <script src="/diy/js/photoClipbak.js?1111"></script>
...
?>
       <dd class="jj_1 <?php if ($this->_foreach['name']['iteration'] == 3): ?>on<?php endif; ?>" data-id="<?php echo $this->_var['key']; ?>"><p class="dog<?php echo $this->_foreach['name']['iteration']; ?>"></p><?php echo $this->_var['item']; ?></dd>
         <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
     </dl>
...
<script type="text/javascript" src="/diy/js/diy2.js?101"></script>
...
<script src="/diy/js/swiper_img.js"></script>
