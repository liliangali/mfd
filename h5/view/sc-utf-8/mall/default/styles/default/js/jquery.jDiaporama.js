            ...
            if($("li", diapo).length > 1){
                ...
                $("li", diapo).each(function(){
                    ...
                    if(options.infos)
                    {
                        ...
                        if(is_title)
                            elt.append("<p class='title' style=display:none>"+$("img", elt).attr("alt")+"</p>");
						
                        if(options.currentimage)
                            elt.append("<p class='count' style=display:none>"+parseInt($("li", diapo).index(elt)+1)+"/"+diapo.children().length+"</p>");
                    }
                })
                ...
                if(options.controls)
                {
                    ...
                    diapo.after("<div class='jDiaporama_controls'><a href='#' class='prev'>Prec.</a> " + ((options.auto)?"<a href='#' style='display:none;' class='pause'>Pause</a>":"") + " <a href='#' class='next'>Suiv.</a></div>");
