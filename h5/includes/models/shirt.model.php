...
class ShirtModel extends BaseModel{
    ...
    function load_parts_cate($cateId=0,$vId=0){
        ...
        $_shirtparts_mod =& m('shirtparts');
    
        $parts = $_shirtparts_mod->find(array("conditions" => "v_id = {$vId} AND top_cate = {$cateId} ",));
    ...
    function setCate(){
        ...
        return setConf('shirt','cate',$shirt);
    }
    /**
     * 获取分类下的工艺分类
     * @return array
