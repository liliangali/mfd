...
class TenpayPayment extends BasePayment
{
    ...
    function get_payform($order_info, $type = 'order')
    {
        ...
        /* 返回的路径 */
        $mch_returl = $this->_create_notify_url($order_info['order_id'], $type);
        $show_url   = $this->_create_return_url($order_info['order_id'], $type);
        $attach = $rand_num;
        ...
        $parameter = array(
            ...
            'sign'              => $sign,                       // MD5签名
            'sys_id'            => '542554970'                  //RCTailor C账号 不参与签名
        );
