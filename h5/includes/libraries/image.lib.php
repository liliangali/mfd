...
/**
 * RCTailor: 后台对上传文件的处理类(实现图片上传，图片缩小， 增加水印)
 * ============================================================================
 ...
 * ============================================================================
 * $Id: image.lib.php 4291 2015-05-30 02:41:45Z gaofei $
 */
...
class imageProcessor
{
    ...
    function initupload()
    {
		...
		swfu = new SWFUpload({
			flash_url:"'.dirname(site_url()) . '/includes/libraries/javascript/swfupload/swfupload.swf?"+Math.random(),
			upload_url:"index.php?app=images&a=swfupload&dosubmit=1",
