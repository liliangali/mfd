...
class Customer_figureModel extends BaseModel
{
     ...
     * 判断用户手机号是否唯一
    */
    function unique($customer_mobile,$storeid,$figure_sn = 0)
    {
...
//            量体信息
           'lw' => array('zname'=>'颈围','isshow'=>1,'ename'=>'英文名称扩展值','logo'=>'图标扩展值'),
        	...
        	'height' => array('zname'=>'身高','isshow'=>1,'ename'=>'英文名称扩展值','logo'=>'图标扩展值'),
        	'weight' => array('zname'=>'体重','isshow'=>1,'ename'=>'英文名称扩展值','logo'=>'图标扩展值'),
