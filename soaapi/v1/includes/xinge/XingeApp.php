...
class XingeApp {
	 ...
	 * 安卓创建批量推送任务
	 */
	public function  CreateMultipushAndroid($accessId, $secretKey, $title, $content, $accounts, $param = array() )
	{
		$push = new XingeApp($accessId, $secretKey);
		//下发安卓
		$mess = new Messages();
	 ...
	 * IOS创建批量推送任务
	 */
	public function  CreateMultipushIos($accessId, $secretKey, $title, $content, $accounts, $param = array() )
	{
		$pushios = new XingeApp($accessId, $secretKey);
